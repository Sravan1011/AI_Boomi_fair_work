...
import { useFBO, useGLTF, useVideoTexture, MeshTransmissionMaterial } from '@react-three/drei';
...
// Full-screen video plane rendered inside the portal — the glass refracts this
function VideoBackground() {
  const texture = useVideoTexture('/hero-bg.mp4', {
    loop: true,
    muted: true,
    start: true,
  ...
  return (
    <mesh position={[0, 0, 0]}>
      <planeGeometry args={[width * 2.5, height * 2.5]} />
...
// Images shown inside the glass scene — dark-background abstracts only
